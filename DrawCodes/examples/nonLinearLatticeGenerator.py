...
class layout(Chip):
    ...
    def __init__(self,name,size=(chipSize,chipSize),mask_id_loc=(0,0),chip_id_loc=(0,0)):
        ...
        for idx in range(12):
            ...
            drawThreewayCaps(mask,drawDictionaries,cap_length,cap_gap,gapw_buffer,stub_length,pinw,stop_pinw,gapw,stop_gapw,bondPadConnectionParameters)
...
if __name__=="__main__":
        ...
        mask.saveas('smallNonlinearLattices01.dxf')
