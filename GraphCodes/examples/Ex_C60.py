...
def run():
    ...
    #        fig.figsize = (100,100)
            ...
            xs = numpy.arange(0,len(GenLayout.Es),1)
    ...
    #        self.points[newItter ] = -self.alpha/2 + numpy.arange(0,2*numpy.pi, 2*numpy.pi/numNewPoints)
            if test.gon == 7:
                test.points[newItter ] = numpy.arange(0,2*numpy.pi, 2*numpy.pi/numNewPoints) - 0*test.alpha/2 + 0.25*(test.itter)**0.5*test.alpha/2.
            elif test.gon == 5:
                if test.itter == 0:
                    test.points[newItter ] = numpy.arange(0,2*numpy.pi, 2*numpy.pi/numNewPoints) + 0.
                else:
    #                self.points[newItter ] = numpy.arange(0,2*numpy.pi, 2*numpy.pi/numNewPoints) + 1.0*self.alpha/2.
                    test.points[newItter ] = numpy.arange(0,2*numpy.pi, 2*numpy.pi/numNewPoints) - 0*test.alpha/2 + 0.25*(test.itter)**0.5*test.alpha/2.
            elif test.gon == 3:  
                test.points[newItter ] =  numpy.arange(0,2*numpy.pi, 2*numpy.pi/numNewPoints) - test.alpha/2/1.5 #old as of 5-23-18
            else:
    ...
    pylab.cla()
    xs = numpy.arange(0, len(C60.Es), 1)
    ...
    pylab.cla()
    xs = numpy.arange(0, len(C84_6.Es), 1)
